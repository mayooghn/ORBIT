...
(0, import_node_test.default)("monitoring counters and event cards remain part of the existing section", () => {
  import_strict.default.match(assistantSource, /<MonitoringMetric label="Detected"/);
  import_strict.default.match(assistantSource, /<MonitoringMetric label="Relevant"/);
  import_strict.default.match(assistantSource, /Recent monitored events/);
  import_strict.default.match(assistantSource, /<MonitoredEventCard/);
});
